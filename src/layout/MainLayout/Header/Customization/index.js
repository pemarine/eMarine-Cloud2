...
import { Avatar, Box, Button, Divider, Drawer, Grid, IconButton, Stack, Tab, Tabs, Tooltip, Typography } from '@mui/material';
import { IconPlus, IconTextSize, IconColorSwatch, IconPalette } from '@tabler/icons-react';
    ...
    return (
        ...
        <Box sx={{ ml: 0.25, mr: 0.25 }}>
            <Tooltip title={open ? 'Exit Fullscreen' : 'Fullscreen'}>
                ...
                >
                    <IconPalette stroke={1.7} size="28px" />
                </Avatar>
            </Tooltip>
        </Box>
            {/* toggle button */}
