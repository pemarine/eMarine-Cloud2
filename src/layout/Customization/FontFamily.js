        ...
        <Stack p={2} spacing={2.5} sx={{ width: '100%' }}>
            ...
            <RadioGroup aria-label="payment-card" name="payment-card" value={font} onChange={handleFont}>
                <Grid container spacing={1.25}>
                    ...
                    <Grid item xs={12}>
                        <MainCard content={false} sx={{ p: 0.75, bgcolor: font === 'Fellix-Medium' ? bgActiveColor : bgColor }}>
                            <MainCard
                                content={false}
                                border
                                sx={{
                                    p: 1.75,
                                    borderWidth: 1,
                                    ...(font === 'Fellix-Medium' && { borderColor: theme.palette.primary.main })
                                }}
                            >
                                <FormControlLabel
                                    sx={{ width: 1 }}
                                    control={<Radio value="Fellix-Medium" sx={{ display: 'none' }} />}
                                    label={
                                        <Typography variant="h5" sx={{ pl: 2, fontFamily: `'Fellix-Medium', sans-serif` }}>
                                            Felix-Medium
                                        </Typography>
                                    }
                                />
